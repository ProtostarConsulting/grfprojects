...
public class PartnerSchoolService {
	...
	public static List<Key<PartnerSchoolEntity>> getSchoolKyesByRegOrFormNo(String autoGenerated, String yearOfExam) {
		String[] yearofExamArray = new String[1];
		yearofExamArray[0] = yearOfExam;
		...
		LoadResult<Key<PartnerSchoolEntity>> second = ofy().load().type(PartnerSchoolEntity.class)
				.filter("examDetailIndex in", yearofExamArray).filter("formNumber", formNumber).keys().first();
