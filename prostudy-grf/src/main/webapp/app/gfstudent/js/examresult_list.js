				...
				function($scope, $window, $mdToast, $timeout, $mdSidenav,
					...
					$scope.searchByGrfRegNoChange = function() {
						...
						if (enteredGrfRegNo && enteredGrfRegNo.length >= 5) {
							...
							// .startsWith('P-2018-') && enteredGrfRegNo.length
							// >= 12) ? enteredGrfRegNo
							// : 'P-2018-' + enteredGrfRegNo;
							$scope.examYearString = $scope.curUser.instituteObj.yearofExam
									.split("-");
							$scope.searchString = 'P-'
									+ $scope.examYearString[0] + '-';
							var grfRegNo = (enteredGrfRegNo
									.startsWith($scope.searchString) && enteredGrfRegNo.length >= 12) ? enteredGrfRegNo
					...
					$scope.schoolSerachTxtChange = function(searchSchoolTxt,
						...
						var gfStudentService = appEndpointSF
								.getGFStudentService();
						gfStudentService
								.searchExamResultBySchoolName(searchSchoolTxt,
										yearOfExam)
								.then(
										function(resultList) {
											if (resultList) {
