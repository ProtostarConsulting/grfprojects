...
@NgModule({
    imports: [BrowserModule, FormsModule, MaterialModule.forRoot(), ProERPModule, SetupModule, SchoolModule, GfBookModule, GfStudentModule, CouriersModule, ReportsModule, ExamDetailModule, LoginModule, AppRoutingModule],
    declarations: [AppComponent, PageNotFoundComponent, ProStudyComponent],
    bootstrap: [AppComponent],
    providers: [RouteData, ApiConfig, GoogleEndpointService, LocalUserService]
})
