...
public class PartnerSchoolService {
	...
	public PartnerSchoolEntity addPartnerSchool(
		...
		if (partnerSchoolEntity.getAutoGenerated() == null
			...
			/*SequenceGeneratorShardedService sequenceGenerator = new SequenceGeneratorShardedService(EntityUtil.getInstituteEntityRawKey(partnerSchoolEntity.getInstitute()), Constants.SCHOOL_REGISTRATION_NO_COUNTER);
			Long nextSequenceNumber = sequenceGenerator.getNextSequenceNumber();
			partnerSchoolEntity.setAutoGenerated(nextSequenceNumber.toString());*/
	...
	public List<PartnerSchoolEntity> getPartnerByInstitute(
		...
		List<PartnerSchoolEntity> schoolList = ofy().load()
				.type(PartnerSchoolEntity.class).filter("instituteID", id).order("autoGenerated")
				.list();
