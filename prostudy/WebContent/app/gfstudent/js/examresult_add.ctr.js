								...
								.then(
										function(resp) {
											...
											if ($scope.foundSchool == null) {
												...
												var userEnteredCoOrdMobileNo = '91' + $scope.data.coordinatorMobileNumberEntered;
												if ($scope.coordinatorDetail == null || userEnteredCoOrdMobileNo.indexOf($scope.coordinatorDetail.coordinatorMobileNum) ==-1 ) {
