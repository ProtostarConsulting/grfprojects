				...
				function($scope, $window, $mdToast, $timeout, $mdSidenav,
					...
					$scope.getGFBookStockByInstituteId = function() {
						...
						gfBookStockService.getGFBookByInstituteId(
								$scope.instituteID).then(function(tempBooks) {
						...
						proadminService
								...
								.then(
										function(settingsOutput) {
											...
											$scope.instituteID = $scope.commonSettingsObj.grfInstituteId;
											$scope.yearofExam = $scope.commonSettingsObj.currYearofExam;
											$scope
