...
function googleEndpointSF($log, $q, $localStorage, $timeout) {
	...
	GFCourierService.touchAllEntities = function() {
		var deferred = $q.defer();
		gapi.client.gfCourierService.touchAllEntities().execute(
				function() {
					deferred.resolve();
				});
	...
	GFCourierService.getPendingPastDate = function(sinceDate) {
		var deferred = $q.defer();
		gapi.client.gfCourierService.getPendingPastDate({"sinceDate":sinceDate}).execute(
				function(resp) {
					deferred.resolve(resp.items);
				});
	...
	GFCourierService.getCourierByGRFNo = function(autoGenerated) {
		var deferred = $q.defer();
