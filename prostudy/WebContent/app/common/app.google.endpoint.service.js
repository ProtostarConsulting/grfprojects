...
function googleEndpointSF($log, $q, $localStorage, $timeout) {
	...
	GFStudentService.searchExamResultBySchoolName = function(searchSchoolTxt, yearOfExam) {
		var deferred = $q.defer();
	...
	GFCourierService.fetchCourierListByPaging = function(id, yearOfExam, pagingInfo) {
		var deferred = $q.defer();
	...
	GFCourierService.searchCourierBySchoolName = function(schoolNameSearchStr, yearOfExam) {
		var deferred = $q.defer();
	...
	GFCourierService.getCourierByLogisticsType = function(logisticsType, yearOfExam) {
		var deferred = $q.defer();
	...
	PartnerSchoolService.searchSchoolByName = function(searchSchoolTxt, yearOfExam) {
		var deferred = $q.defer();
	...
	PartnerSchoolService.getSchoolByAutoGeneratedID = function(autoGenerated, yearOfExam) {
		var deferred = $q.defer();
